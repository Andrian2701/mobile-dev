...
fun LabsScreen(
    ...
    subjectId: Int,
    vm: LabsViewModel = koinViewModel()
) {
    val subject by vm.subjectFlow(subjectId).collectAsState(initial = null)
    val labs by vm.labsFlow(subjectId).collectAsState(initial = emptyList())
